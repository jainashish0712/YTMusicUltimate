    ...
    dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_DEFAULT, 0), ^{
        ...
        if (hasImpulse) {
            ...
            arguments = @[
                @"-i", audioURL,
                @"-i", impulsePath,
                @"-filter_complex", @"[1:a]pan=stereo|c0=0.5*c0+0.5*c2|c1=0.5*c1+0.5*c3[imp];[0:a]asetrate=44100*1.04,aresample=44100,atempo=0.96,volume=5,equalizer=f=63:width_type=h:width=50:g=4,equalizer=f=100:width_type=h:width=80:g=4,equalizer=f=160:width_type=h:width=100:g=4.3,equalizer=f=250:width_type=h:width=120:g=2,equalizer=f=400:width_type=h:width=150:g=1.5,equalizer=f=630:width_type=h:width=200:g=-1.9,equalizer=f=1000:width_type=h:width=300:g=-7.5,equalizer=f=1600:width_type=h:width=400:g=-5.8,equalizer=f=2500:width_type=h:width=500:g=-0.2,equalizer=f=4000:width_type=h:width=600:g=-0.2,equalizer=f=6300:width_type=h:width=800:g=5.3,equalizer=f=10000:width_type=h:width=1000:g=6.9,equalizer=f=16000:width_type=h:width=1200:g=-10.3[p];[p][imp]afir=dry=0.2:wet=0.8,loudnorm=I=-16:TP=-1.5:LRA=11",
                @"-map_metadata", @"0",
