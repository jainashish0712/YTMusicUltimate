...
$(TWEAK_NAME)_CFLAGS = -fobjc-arc -std=c++11 -Wno-deprecated-declarations -DTWEAK_VERSION=$(PACKAGE_VERSION)
$(TWEAK_NAME)_CCFLAGS = -std=c++11
$(TWEAK_NAME)_FRAMEWORKS = UIKit Foundation AVFoundation AudioToolbox VideoToolbox Photos
